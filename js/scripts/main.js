...
document
  ...
  .addEventListener("click", function () {
    ...
    youtubeDiv.innerHTML =
      '<iframe width="100%" height="315" src="https://www.youtube.com/embed/xCjv3TL6N1Q?autoplay=1&controls=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>';
  });

document.getElementById("map-thumbnail").addEventListener("click", function () {
  // Substituir a imagem pelo iframe do Google Maps quando o usuário clicar
